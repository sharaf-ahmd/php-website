...
$sql="select * from `admin_details` where firstname='$docid'";
...
<form action="../php1/update_admin.php" method="post" enctype="multipart/form-data">

<div class="form-group row">
<label for="dd" class="col-sm-4 col-form-label" class="sr-only">Passenger ID</label>
		<div class="col-sm-8">
		<input class="form-control" type="text" id="dd" name="doctorid" required maxlength="6"  pattern="[a-zA-Z]+" autofocus readonly value="<?php echo $row['admin_id'] ?>" >
		</div>
</div>
