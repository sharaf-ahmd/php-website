...
$rid=$_POST['routeid'];
$sql="select * from `routes` where r_id='$rid'";
...
<div class="container" id="myform">
<h4  style="font-variant:small-caps;text-align:center">View and Update Routes</h4>

<form action="../php1/update_routes.php" method="post" enctype="multipart/form-data">
	   <div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input id="fro" class="form-control col-sm-10"  name="dtown" required type="text"  value="<?php echo $row['departure_town'] ?>">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input id="t" class="form-control col-sm-10"  name="atown" required type="text"  value="<?php echo $row['arrival_town'] ?>">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-4 col-form-label" for="from">Departure time</label>
			<div class="col-sm-4">
				<input id="fro" class="form-control col-sm-10"  name="dtime" required type="time"  value="<?php echo $row['departure_time'] ?>">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input id="t" class="form-control col-sm-10"  name="atime" required type="time"  value="<?php echo $row['arrival_time'] ?>">
			</div>
		</div>
		  ...
		  <div class="form-group row">
			...
			<div class="col-sm-4">
				<input id="fn" class="form-control" maxlength="25" name="price"  required="" type="text" value="<?php echo $row['price'] ?>">
			</div>
		</div>
...
<div class="col-sm-3">
 <button type="submit" class="form-control btn btn-primary" name="update">Update Route</button>
   </div> 
