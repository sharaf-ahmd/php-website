...
<div class="container" id="myform">
<h4  style="font-variant:small-caps;text-align:center">Cancel Booking</h4>

<form action="../php1/delete_bookings.php" method="post" enctype="multipart/form-data">
	<div class="form-group row">
			...
			<div class="col-sm-4">
				<input id="ps" class="form-control col-sm-10" maxlength="2"  name="nop" pattern="[0-9]+" required type="text" readonly value="<?php echo $row['no_of_passenger'] ?>">
			</div>
					</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input id="fro" class="form-control col-sm-10"  name="from" required type="text" readonly value="<?php echo $row['from'] ?>">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input id="t" class="form-control col-sm-10"  name="to" required type="text" readonly value="<?php echo $row['to'] ?>">
			</div>
		</div>
        ...
        <option value="Shuttle" <?php if($row['bus_type']=='Shuttle') echo 'selected'?>>Shuttle</option>
			...
			<div class="col-sm-8">
				<input id="ln" class="form-control" name="date" type="datetime-local" readonly value="<?php echo $row['date'] ?>">
			</div>
		</div>
	    ...
	    <option value="Pay at the station"  selected readonly>Pay at the station</option>
	    </select>
        </div> 
        </div>
...
<div class="col-sm-3">
 <button type="submit" class="form-control btn btn-primary" name="update">Cancel Booking</button>
   </div> 
